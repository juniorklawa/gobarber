...
describe('SendForgotPasswordEmail', () => {
  ...
  it('should generage a forgot passwork token', async () => {
    const generageToken = jest.spyOn(fakeUserTokensRepository, 'generate');
    ...
    expect(generageToken).toHaveBeenCalledWith(user.id);
  });
});
